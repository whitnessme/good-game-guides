...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert('GameGuides', [
      ...
      coverImg:'../public/images/guides/spyro_guide.jpg', createdAt: new Date(), updatedAt: new Date() },
      ...
      coverImg:'../public/images/guides/horizon_zero_dawn_guide.jpg', createdAt: new Date(), updatedAt: new Date() },
      ...
      coverImg:'../public/images/guides/loz_botw_guide.jpg', createdAt: new Date(), updatedAt: new Date() },
      ...
      coverImg:'../public/images/guides/sims_4.jpg', createdAt: new Date(), updatedAt: new Date() },
      ...
      coverImg:'../public/images/guides/featured-minecraft-best-enchantments.jpg', createdAt: new Date(), updatedAt: new Date() },
      ...
      coverImg:'../public/images/guides/pokemon_diamond_pearl.jpg', createdAt: new Date(), updatedAt: new Date() },
